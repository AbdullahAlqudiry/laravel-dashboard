<x-layouts.clean :title="__('trans.Update Password Page Title')">
            ...
            <div class="card overflow-hidden">
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-primary p-4">
                                <h5 class="text-primary">{{ __('trans.Update Password Page Title') }}</h5>
                                <p>{{ __('trans.Update Password Page Sub Title') }}</p>
                            </div>
                        </div>
                ...
                <div class="card-body pt-0"> 
                    ...
                    <div class="p-2">
                        ...
                        {{ Aire::hidden('token', request()->token) }}
                            ...
                            <div class="mt-3">
                                {{
                                    Aire::button()
                                    ->labelHtml(__('trans.Update Password Page Button'))
